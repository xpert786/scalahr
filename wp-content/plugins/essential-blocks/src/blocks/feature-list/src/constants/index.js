...
export const badgePadding = "badgePadding";
...
export const badgeBackgroundType = "badgeBg";
...
// list
export const listBackgroundType = "listBg";
export const listBorderShadow = "listBrdSdw";
export const listPadding = "listPadding";
